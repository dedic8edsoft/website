    ...
    <section className="contact-form-section bg-white py-25">
      <div className="container mx-auto">
        ...
        <p className="section-description">
          Connecting with us is just a click away—whether you have questions, ideas, or are ready to embark on a collaboration. 
          Our team at is eager to hear from you. 
          Reach out through our contact form, and let's start a conversation about turning your vision into reality.
        </p>
        <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-10">
          <div>
            <h2 className="text-28 font-bold mb-3">Contact Details</h2>
            <p className="text-gray-500">
              We look forward to hearing from you and exploring how we can contribute to your success.
            </p>
            <div className="flex flex-col gap-3 mt-7">
              <p>Sreet Martin Camaj 4001 Shkoder, Albania</p>
